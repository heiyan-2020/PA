...
def_THelper(rr) {
	...
	def_INSTR_TAB("0000000 ????? ????? 100 ????? ????? ??", myxor);
	def_INSTR_TAB("0000000 ????? ????? 110 ????? ????? ??", myor);
	def_INSTR_TAB("0000000 ????? ????? 001 ????? ????? ??", sll);
	def_INSTR_TAB("0100000 ????? ????? 101 ????? ????? ??", sra);
	def_INSTR_TAB("0000000 ????? ????? 101 ????? ????? ??", srl);
	def_INSTR_TAB("0000000 ????? ????? 111 ????? ????? ??", myand);
...
def_THelper(main) {
  ...
  def_INSTR_TAB  ("??????? ????? ????? ??? ????? 11010 11",         nemu_trap);
	def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I			, computation);
